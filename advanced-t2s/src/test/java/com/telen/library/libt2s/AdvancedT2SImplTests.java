...
@PrepareForTest({TextToSpeechInstance.class, Log.class, TextUtils.class})
public class AdvancedT2SImplTests {
    ...
    public void setup() {
        ...
        AdvancedT2SImpl.Builder builder = new AdvancedT2SImpl.Builder(mContext);
    ...
    /*doAnswer(invocation -> {
            ...
            args[0] = mockUtteranceProgressListener;
            return null;
        }).when(tts).setOnUtteranceProgressListener(any());*/
}
